...
@MainActor class Cache {
    ...
    func setObject<T: Codable & Sendable>(_ object: T, forKey key: String, ttl: TimeInterval = 1800) {
    ...
    func getObject<T: Codable & Sendable>(forKey key: String, type: T.Type) -> T? {
        return queue.sync {
    ...
    private nonisolated func hash(_ string: String) -> String {
